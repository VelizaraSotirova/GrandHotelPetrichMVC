        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevenueSourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Revenues_PaymentMethods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Revenues_RevenueSources_RevenueSourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastInspected = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomStatuses_Bookings_CurrentBookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Revenues_PaymentMethodId",
                table: "Revenues",
                column: "PaymentMethodId");

            migrationBuilder.CreateIndex(
                name: "IX_Revenues_RevenueSourceId",
                table: "Revenues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomStatuses_CurrentBookingId",
                table: "RoomStatuses",
